  ...
  return (
    <section className="pb-16 lg:py-24">
      <div className="container">
        ...
        <h2 className="font-serif text-3xl md:text-5xl text-center mt-6">My coding experience</h2>
